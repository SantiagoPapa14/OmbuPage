      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-sans text-[#555555] mt-5 max-w-2xl mx-auto leading-relaxed">
            Los pilares que definen nuestra forma de informar y analizar el
            mundo financiero.
          </p>
        </div>

        {/* Values Grid */}
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-[1px] bg-[#E5E2DB]">
          {values.map((value) => (
            <div
              key={value.title}
            ...
            >
              <div className="inline-flex items-center justify-center p-4 border border-[#E5E2DB] mb-5 group-hover:border-[#C9973F] transition-colors">
                <value.icon
                  className="text-[#14332A] group-hover:text-[#C9973F] transition-colors"
                  size={28}
                />
              </div>
